...
const PRJ = [
  {
    ...
    links_desc: {
      ...
      "إدخال عقد جديد":
        "Contract Wizard — 10 خطوات لإدخال عقد فندق (يطلب تسجيل الدخول)",
      "قائمة العقود":
        "كل العقود المحفوظة — للمراجعة والتعديل والحذف (يطلب تسجيل الدخول)",
      Railway:
        "لوحة النشر — اللوغات، المتغيرات، الفروع، إعادة التشغيل",
      GitHub:
        "الكود المصدري — Next.js 16 + Supabase + 1875 اختبار يمر",
      Supabase:
        "قاعدة البيانات — جداول العقود والفترات والأسعار والخصومات ومعاملات الإشغال",
    },
    current_status: {
      updated: "2026-05-06",
      where:
        "النظام حي ومنشور وآمن. تمّت جولة إصلاحات شاملة في 5-6 مايو 2026 — أُغلقت ثغرة المصادقة الحرجة التي كانت تعرّض إنشاء وتعديل وحذف العقود بدون تحقق، طُبّق تدقيق الأمان الأسبوعي بكامل إصلاحاته الثلاثة عشر، أُصلحت العملة المشفرة، أُصلح توزيع أسعار الأطفال للإقامات متعددة الفترات، وأُضيفت قاعدة الرضيع المجاني في المكملات. في قاعدة البيانات تمّ تصحيح تسعة معاملات إشغال خاطئة في فترة ذروة عقد ريكسوس، وتحويل قابلية دمج الخصومات إلى حصرية، وإضافة خصم الحالات العاجلة بنسبة خمسة وعشرين بالمئة. النشر على ريلواي مُنعش وشغّال على الإصدار خمسة عشر نقطة أربعة نقطة اثنين، يجتاز ألفاً وثمانمئة وخمسة وسبعين اختباراً، صفر ثغرات حرجة، والمسارات المحمية ترفض الطلبات بدون توكن.",
      next_step:
        "أولاً، اختبر النظام الحي بنفسك — جرّب الدخول بصفحة كونتراكت ويزرد ثم رمز الإدارة. ثانياً، إصلاح سعات الغرف اللاثنتين والعشرين في ريكسوس عند الحصول على القيم. ثالثاً، استخراج أخطاء سوينو الثمانية من أرشيف الجلسة القديمة وإصلاحها. رابعاً، إدخال بقية العقود التسعة من ملفات بي دي إف في data/contracts.",
      blockers: [
        {
        ...
        {
          text: "ثمانية أخطاء معلّقة في عقد سوينو ديلوكس من جلسة سابقة — تحتاج استخراجها من أرشيف الجلسة لتحديدها",
          priority: "med",
        },
        {
      ...
      use_guide:
        "للاستخدام اليومي: افتح رابط البحث عن أسعار، ابحث بفندق وتاريخ وعدد ضيوف. لإدخال عقد فندق جديد: افتح رابط إدخال عقد جديد، سجّل الدخول برمز الإدارة، وامرّ على الخطوات العشر. لتصحيح عقد موجود: افتح قائمة العقود، اختر تعديل. للتطوير المحلي: افتح آيتيرم تو ونفّذ أمر استئناف كلود بالأسفل، ثم بنبم انستول وبنبم رن ديف داخل هوتيل ويب آب. للنشر: ادفع لفرع مين على غيت هب وريلواي ينشر تلقائياً.",
    },
    claude_session: {
