  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        name: "دراسة عقود BRIX — مرونة النظام",
        freq: "٧×/يوم تقريباً كلّ ٣ ساعات و٢٥ دقيقة (مهمّة استكشاف مؤقّتة، مدّة أسبوع)",
        on: true,
        what: "مهمّة استكشاف طويلة لمدّة أسبوع (أُنشِئَت 2026-05-24، تَنتهي 2026-05-31). تَدور كلّ دورة على ٥ مجموعات فندقيّة بالتناوب من docs/عقود (نحو ٦٠ مجموعة إجمالاً). كلّ مجموعة تُدرَس على ٤ مراحل في وكيل واحد: استخراج بنود العقد، مطابقتها بقدرات النظام، كشف الثغرات، مراجعة شكوكيّة. النتيجة تَستبدل قسم تلك المجموعة في docs/contract-study/index.html (لا أرشيف، الملفّ يَعكس آخر صورة). الهدف: قياس مرونة النظام قبل توقيع عقود جديدة. لا تَعديل على الكود — استكشاف خالص. بعد انتهاء الأسبوع: مراجعة بشريّة ثمّ قرار بإيقاف المهمّة أو تَحويلها إلى دوريّة أخفّ. تنبيه: لا تُعِد تشغيلها بشكل آخر بعد ٢٠٢٦-٠٥-٣١ دون قرار صريح.",
        prj: ["BRIX Travel System"],
        path: "docs/contract-study/ (index.html + results/ + build.mjs + SYSTEM_CAPABILITIES.md)",
        kind: "study",
      },
    ],
  },
