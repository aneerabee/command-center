...
const PRJ = [
  ...
  },
  {
    ...
    ops: [
      ...
      "هوية ADREEM مطبقة في الكود والواجهة والبوت، وGitHub Pages أعيد بناؤه بنجاح من commit f1dd59d",
      ...
      "GitHub Pages منشور من commit f1dd59d عبر Workflow 26717595556، والرابط الحي ورابط خيارات التصميم رجعا 200",
      "تشغيل Contabo آخر تأكيد له كان على commit 758cfeb: adreem-api.service active و adreem-bot.service active، لكن تحديث السيرفر إلى f1dd59d لم يتم من هذه الجلسة بسبب رفض SSH لكلمة المرور المتاحة",
    ...
    claude_session: {
      ...
      note: "آخر نقطة 2026-05-31: ADREEM محدّث في GitHub إلى commit f1dd59d، رابط التصميم منشور، Pocket Ledger محسّن، والاختبارات المحلية والبناء والنشر نجحت.",
    },
  },
  {
    name: "LIBYA",
...
const BOT = [
  ...
  },
  {
    ...
    check_note: "adreem-bot.service active على Contabo من آخر نسخة مؤكدة commit 758cfeb. كود البوت المحلي/GitHub وصل إلى f1dd59d، لكن تحديث Contabo لم يتم في فحص 2026-05-31 بسبب Permission denied عبر SSH. Telegram getMe سبق ونجح للبوت SystemAzol_bot، وallowlist مفعّل لمستخدم Telegram المحدد. البوت القديم legacy mohammad-ledger-bot.service أصبح inactive لتجنب تضارب polling.",
    runtime: "Node.js 20.20.1 / systemd user",
    memory_mb: 48,
    started_at: null,
    pid: null,
    ...
    current_status: {
      updated: "2026-05-31",
      where:
        "يعمل على Contabo في /home/argaz/apps/adreem من آخر commit مؤكد 758cfeb. adreem-bot.service active وadreem-api.service active حسب آخر فحص سيرفر ناجح. الكود الأحدث في GitHub هو f1dd59d ويحتوي تحسينات Pocket Ledger للبوت، لكن تحديث السيرفر إليها لم يكتمل من هذه الجلسة بسبب Permission denied في SSH.",
      next_step:
