...
const PRJ = [
  ...
  },
  {
    ...
    users_count: 2,
    priority: "med",
    next_milestone: "استخدام يومي مراقب لمدة 24 ساعة ثم اعتماد القبول النهائي",
    summary:
    ...
    ops: [
      ...
      "مصدر البيانات السحابي: صف مستقل لكل دفتر داخل Supabase ml_state، ويُختار الدفتر من جلسة المستخدم أو ربط تيليغرام",
      ...
      "آخر تحقق قوي 2026-08-19: فحص الأنواع والجودة والبناء نجح، و30 ملف اختبار تضم 212 اختبارًا نجحت بالكامل، ولا توجد ثغرات حزم معروفة",
      "GitHub Pages نشر commit ce9bffa بنجاح، والرابط الحي يعرض حزمة ADREEM الجديدة ويرتبط بـ https://www.brixtravel.com/adreem-api",
      "تشغيل Contabo مؤكد على commit ce9bffa: adreem-api.service و adreem-bot.service نشطتان عبر systemd user وتشغّلان node مباشرة",
      ...
      "RLS لجدول ml_state مغلق، ومخزن adreem-attachments خاص بحد 10MB، ونسخ الدفاتر التلقائية محفوظة في ledger-backups بصلاحية 700",
      ...
      "ثُبّت الإصدار الرسمي v1.0.0 على commit ce9bffa بعد نجاح الفحوص والنسخة الاحتياطية",
    ...
    desc: "ADREEM — دفتر مالي للهاتف والويب والبوت\n\n🎯 الهدف:\nنظام مالي مستقل لكل مستخدم، يفصل الدفاتر بصرامة، ويجعل الإدخال والمراجعة من الهاتف أو Telegram بنفس المنطق ونفس مصدر البيانات السحابي.\n\n💰 نموذج الحسابات:\nشخص أو جهة: علاقة مالية واضحة، إما أقبض منه أو أدفع له\nفلوسي كاش: مال نقدي مملوك، مع تحديد العملة دينار/دولار\nفلوسي في مصرف: حساب أو محفظة أو بطاقة مصرفية، مع تحديد العملة دينار/دولار\nأصل: شيء مملوك له قيمة ويمكن تتبع مصاريفه وإيراداته\nمشروع/مركز تكلفة: نشاط له دخل ومصاريف وربح/خسارة\nمصروف: تكلفة نهائية تخصم من حساب مالي ولا تُعامل كشخص\n\n🔄 الحركات:\nتحويل بين حسابين متوافقين في النوع والعملة\nمصروف من حساب واحد بدون طرف ثانٍ\nدخل، وبيع/شراء دولار بسعر صرف\nتصحيح ورصيد افتتاحي، والحركة الناقصة تذهب للمراجعة ولا تؤثر على الرصيد\nربط اختياري بمشروع أو أصل، ومرفق خاص، وتكرار شهري يمنع التكرار المزدوج\n\n📊 التشغيل:\nتقرير ربح/خسارة للمشروع أو الأصل بالدينار والدولار\nمطابقة رصيد فعلية تسجل الفرق وتنتج تصحيحًا عند الاعتماد\nتنبيهات للحركات الناقصة، التصنيف، الفروقات، الحركات الكبيرة، والتكرار المستحق\nالحركات الأخيرة قابلة للتعديل أو الإلغاء مع بقاء أثرها في السجل\n\n🧠 المنطق المشترك:\nالويب والبوت يستخدمان نفس قلب الحساب وشروط الحركة والحسابات المسموحة\nلا تحويل من الحساب إلى نفسه ولا تحويل مخالف للنوع أو العملة\nلا يُسمح لرصيد مالي مملوك أو أصل أن يصبح سالبًا\nكل حركة تعرض تأثيرها قبل الحفظ، والأرقام بفواصل آلاف وبدون كسور إلا سعر الصرف\n\n📱 الواجهة:\nأربع مناطق ثابتة: إدخال سريع، الأرصدة، الحركات، التقارير والمراجعة\nالهاتف أولًا، مع خطوات قصيرة، رجوع وتعديل، بحث واضح، وانتقال ثابت بلا تداخل\n\n👥 المستخدمون:\nإدارة المستخدمين من الويب بحساب المالك، بلا رمز إدارة منفصل\nكل مستخدم له بريد وكلمة مرور ودفتر مستقل؛ كلمة المرور تحفظ كبصمة فقط\nجلسة الدخول تبقى على الجهاز حتى تسجيل الخروج أو حذف بيانات الموقع\nرقم تيليغرام اختياري لربط المستخدم بدفتره في البوت\n\n🤖 البوت:\nمساعد خطوة بخطوة للحسابات والحركات والمراجعة والمطابقة والتقارير والتنبيهات\nيعدل رسالة واحدة قدر الإمكان، ويدعم الرجوع والإلغاء ومنع التأكيد المكرر\nإنشاء الشخص يتجاوز خطوة النوع المكررة، وقوائم الحسابات تُفلتر حسب العملة والمنطق\n\n🛡️ الأمان والحفظ:\nالويب لا يحمل مفاتيح Supabase ولا يخزن بيانات الدفتر محليًا\nكل حفظ يمر عبر API مع تحقق سلامة، والدفاتر معزولة بالجلسة\nRLS مغلق، والمرفقات في مخزن خاص بحد 10MB\nنسخة تلقائية قبل وبعد كل حفظ مهم، وسجل تشغيل على الخادم\nمستخدم مراقبة مستقل يفحص الدخول والقراءة دون الوصول إلى دفاتر الأشخاص",
    tags: [
      "React 19",
      "Vite 8",
      "Supabase",
    ...
    current_status: {
      updated: "2026-08-19",
      where:
        "ADREEM v1.0.0 منشور من كود commit ce9bffa. الرابط وواجهة البيانات يعملان، والخدمتان نشطتان على Contabo. نجح فحص الدخول والقراءة العام بمستخدم مراقبة معزول، و212 اختبارًا، والبناء وفحص الجودة والحزم. الويب سحابي فقط، والمرفقات خاصة، والنسخ التلقائية مفعلة.",
      next_step:
        "ابدأ الاستخدام اليومي بحركات حقيقية قليلة، وراقب أول 24 ساعة قبل وضع علامة الإصدار الرسمي.",
      blockers: [],
      use_guide:
        "للاستخدام اليومي: افتح https://aneerabee.github.io/adreem/ وسجّل الدخول، أو استخدم https://t.me/SystemAzol_bot بعد ربط رقم تيليغرام. لإدارة المستخدمين افتح ?admin=users بحساب المالك. للتطوير استخدم /Users/rabeeshaban/Developer/adreem فقط، ثم pnpm typecheck وpnpm lint وpnpm test وpnpm build.",
    },
    claude_session: {
      ...
      note: "آخر تحقق 2026-08-19 على commit ce9bffa: GitHub Pages وAPI والخدمتان تعمل، وفحص الدخول والدفتر نجح. للاستعمال اليومي ادخل من الرابط العام، ولإدارة المستخدمين افتح ?admin=users بحساب المالك. لا تشغّل Claude telegram plugin بالتوازي مع البوت.",
    },
  },
  {
    name: "LIBYA",
...
const SVC = [
  ...
  },
  {
    ...
    info: "ADREEM Bot يعمل 24/7 على Contabo من commit ce9bffa. سجل المستخدمين يعزل كل رقم تيليغرام في دفتره، وإنشاء المستخدمين من صفحة إدارة الويب. فحص getMe وgetWebhookInfo نجح: polling فقط، لا webhook، لا رسائل معلقة، ولم يظهر خطأ خلال دورة انتظار كاملة بعد ضبط المهلة.",
    last_check: "2026-08-19 Contabo runtime",
    config_paths: [
  ...
  },
  {
    ...
    info: "خدمة ADREEM API تعمل من commit ce9bffa عبر node مباشرة على المنفذ 8787. فحص 2026-08-19 نجح للصحة وتسجيل الدخول وقراءة دفتر مراقبة معزول. الإدارة تعتمد صلاحية حساب المالك، والحفظ يتحقق من سلامة الدفتر، والمرفقات في مخزن خاص، والنسخ التلقائية مفعلة.",
    last_check: "2026-08-19 Contabo runtime",
    config_paths: [
      "server:/home/argaz/apps/adreem",
      "server:/home/argaz/apps/adreem/adreem.env",
    ...
    why: "هذه هي بوابة الويب الآمنة إلى دفاتر ADREEM: تسجيل الدخول، عزل المستخدم، إدارة المستخدمين، الحفظ المتحقق، والمرفقات الخاصة. البوت يشترك معها في قلب الحساب ومصدر Supabase لكنه يحفظ من خدمته على الخادم.",
  },
  {
...
const BOT = [
  ...
  },
  {
    ...
    check_note: "Claude Code CLI متاح عبر claude command. عند تشغيل claude --channels plugin:telegram تظهر رسائل Telegram داخل Terminal وقد تختلط ذهنيًا مع بوتات المشاريع؛ لا تتركه يعمل بالتوازي مع بوت ADREEM.",
    runtime: "Claude Code + plugin",
    channel: "Telegram",
    related_entities: ["Command Center"],
    summary: "قناة تحكم عن بُعد بـ Claude Code عبر Telegram؛ ليست بوت ADREEM وليست بوت أي مشروع مالي.",
    desc: "بوت Telegram للتحكم بـ Claude Code عن بُعد\n\nPlugin: telegram@claude-plugins-official v0.0.4\nMCP Server — grammy + Bun\n\n📍 الموقع:\n/Users/rabeeshaban/.claude/channels/telegram\n\n🔐 الوصول:\nPolicy: allowlist — مغلق للغرباء\nمسموح: ID واحد فقط (أنت)\nلا تاريخ رسائل · لا بحث\n\n🛠️ أدوات البوت:\nreply — إرسال ردود + مرفقات حتى 50MB\nreact — إيموجي ريأكشن على رسائلك\nedit_message — تعديل رسائل البوت (progress)\n\n📸 الصور الواردة:\nتُحفظ تلقائياً في inbox/ وتُقرأ مباشرة\n\n🚀 التشغيل:\nclaude --channels plugin:telegram@claude-plugins-official\n\n⚠️ ملاحظة مهمة:\nهذا ليس بوت ADREEM. الرسائل التي تظهر داخل Terminal مثل brixtravel أو Command Center تأتي من جلسة Claude Telegram إذا كانت مفتوحة. أغلق هذه الجلسة عند اختبار بوت ADREEM حتى لا يحدث خلط في الردود.",
    tags: [
      "MCP Server",
      "grammy",
      "Bun",
  ...
  },
  {
    ...
    host: "Contabo VPS",
    last_check: "2026-08-19 Contabo runtime",
    last_run: "active on Contabo · commit ce9bffa",
    check_method: "SSH/systemd + Telegram getMe + ADREEM runtime verifier",
    uptime_status: "active",
    check_note: "adreem-bot.service active على Contabo من commit ce9bffa. Telegram getMe وgetWebhookInfo نجحا؛ polling يعمل بلا webhook أو رسائل معلقة. registry يعزل كل مستخدم في ledgerId الخاص به، وإنشاء المستخدمين من صفحة الإدارة. دورة انتظار كاملة بعد ضبط المهلة لم تسجل أخطاء جديدة.",
    runtime: "Node.js 20.20.1 / systemd user",
    memory_mb: 48,
    started_at: null,
    pid: null,
    exec_start: "/usr/bin/node server/telegram/bot.js",
    channel: "Telegram",
    ...
    desc: "بوت ADREEM — يعمل سحابيًا على Contabo\n\n🎯 الهدف:\nإدخال الحسابات والحركات ومراجعة الأرصدة والسجل من Telegram، بنفس منطق الويب ونفس مصدر البيانات.\n\n✅ التشغيل:\nadreem-bot.service نشطة عبر systemd user من commit ce9bffa\nTelegram polling فقط بلا webhook، وgetMe ناجح\nكل مستخدم مرتبط بدفتر مستقل عبر registry/ledgerId\nإنشاء المستخدمين من صفحة إدارة الويب فقط\n\n✅ الوظائف:\nإدخال الحركة خطوة بخطوة مع رجوع وإلغاء وملخص قبل الحفظ\nإنشاء الحساب بنفس تصنيفات الويب، مع تجاوز خطوة النوع إذا كان الخيار واحدًا\nفلترة الحسابات حسب العملة والنوع ومنع المصدر والوجهة غير المنطقيين\nمطابقة الرصيد، التنبيهات، التقارير، الحركات الشهرية، السجل والمراجعة\nمرفق اختياري خاص، وربط بمشروع أو أصل، ومنع التأكيد المكرر\nإلغاء الحركة الحديثة مع إبقائها في السجل\n\n🧠 الاتساق:\nالمعاينة والحفظ يستخدمان نفس قلب الحساب في الويب\nالحركة الناقصة تذهب للمراجعة ولا تؤثر على الرصيد\nالحساب المالي المملوك لا يمكن أن يصبح سالبًا\n\n📍 التشغيل:\nالمضيف: Contabo VPS vmi3061403\nالمسار: /home/argaz/apps/adreem\nالخدمة: adreem-bot.service\nالسجلات: /home/argaz/logs/adreem-bot.log و adreem-bot-error.log\nالتشغيل: /usr/bin/node server/telegram/bot.js\n\n🔐 الأمان:\nالمفاتيح في adreem.env على الخادم فقط بصلاحية 600\nلا حفظ بدون تأكيد نهائي\nلا تشغّل قناة Claude Telegram بالتوازي حتى لا تختلط الرسائل",
    tags: [
      "Telegram",
      "Node.js",
      "Supabase",
    ...
    current_status: {
      updated: "2026-08-19",
      where:
        "يعمل على Contabo من commit ce9bffa. الخدمتان نشطتان، وفحص تسجيل الدخول والدفتر نجح. getMe وgetWebhookInfo نجحا، ولا توجد رسائل معلقة أو webhook، ودورة polling كاملة بعد التحديث لم تسجل خطأ جديدًا.",
      next_step:
        "استخدام يومي مراقب لأول 24 ساعة ومراجعة أي تنبيه يظهر من شاشة التنبيهات.",
      use_guide:
