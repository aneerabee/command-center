...
const PRJ = [
  ...
  },
  {
    ...
    ops: [
      ...
      "هوية ADREEM مطبقة في الكود والواجهة والبوت، وGitHub Pages أعيد بناؤه بنجاح من commit 85f791f",
      ...
      "آخر تحقق قوي 2026-05-31: npm test نجح بـ105 اختبارات، npm run lint نجح، npm run build نجح، وفحص Chrome/CDP للهاتف والكمبيوتر بدون horizontal overflow",
      "اختبار سيناريوهات منطقي بعد آخر تعديل نجح: 29 تحقق لمسارات التحويل والمصروف والدخل وبيع/شراء الدولار وفلاتر عملة الحسابات",
      "GitHub Pages منشور من commit 85f791f عبر Workflow 26724070813، والرابط الحي رجع 200. تعديل 85f791f يخص bot/server لذلك أصول واجهة الويب قد تبقى بنفس hash السابق وهذا طبيعي",
      "تشغيل Contabo آخر تأكيد له كان على commit 758cfeb: adreem-api.service active و adreem-bot.service active، لكن تحديث السيرفر إلى 85f791f لم يتم من هذه الجلسة بسبب رفض SSH لكلمة المرور المتاحة",
    ...
    current_status: {
      updated: "2026-05-31",
      where:
        "ADREEM منشور على GitHub Pages من commit 85f791f. Workflow 26724070813 نجح: test + build + deploy. الرابط الحي يعمل، وAPI العام يعمل عبر https://www.brixtravel.com/adreem-api. محليًا نجحت 105 اختبارات، lint، build. تم تطبيق إعادة تصميم ويب شاملة لسطح ADREEM، ثم تمت مواءمة Telegram Bot مع Ledger OS في النصوص والأزرار: إدخال حركة، حساب جديد، الأرصدة، سجل اليوم، السجل، مراجعة، بحث. تنبيه: السيرفر/البوت على Contabo آخر نسخة مؤكدة لهما 758cfeb إلى أن يتم دخول SSH صحيح وتحديثهما.",
      next_step:
    ...
    claude_session: {
      ...
      note: "آخر نقطة 2026-05-31: ADREEM محدّث في GitHub إلى commit 85f791f، وتمت مواءمة Telegram Bot مع Ledger OS بعد إعادة تصميم الويب، مع بقاء منطق البيانات كما هو. npm run lint وnpm test وnpm run build نجحت.",
    },
  },
  {
    name: "LIBYA",
...
const BOT = [
  ...
  },
  {
    ...
    check_note: "adreem-bot.service active على Contabo من آخر نسخة مؤكدة commit 758cfeb. كود البوت المحلي/GitHub وصل إلى 85f791f، لكن تحديث Contabo لم يتم في فحص 2026-05-31 بسبب Permission denied عبر SSH. Telegram getMe سبق ونجح للبوت SystemAzol_bot، وallowlist مفعّل لمستخدم Telegram المحدد. البوت القديم legacy mohammad-ledger-bot.service أصبح inactive لتجنب تضارب polling.",
    runtime: "Node.js 20.20.1 / systemd user",
    memory_mb: 48,
    started_at: null,
    pid: null,
    ...
    current_status: {
      updated: "2026-05-31",
      where:
        "يعمل على Contabo في /home/argaz/apps/adreem من آخر commit مؤكد 758cfeb. adreem-bot.service active وadreem-api.service active حسب آخر فحص سيرفر ناجح. الكود الأحدث في GitHub هو 85f791f ويحتوي إعادة تصميم ويب شاملة وتحسين Telegram UX ليتناسق مع Ledger OS، لكن تحديث السيرفر إليها لم يكتمل من هذه الجلسة بسبب Permission denied في SSH.",
      next_step:
