...
const PRJ = [
  ...
  },
  {
    ...
    users_count: 2,
    priority: "med",
    next_milestone: "استخدام يومي مراقب لمدة 24 ساعة ثم تثبيت أول إصدار رسمي",
    summary:
    ...
    current_status: {
      updated: "2026-08-19",
      where:
        "ADREEM منشور من commit ce9bffa. الرابط وواجهة البيانات يعملان، والخدمتان نشطتان على Contabo. نجح فحص الدخول والقراءة العام بمستخدم مراقبة معزول، و212 اختبارًا، والبناء وفحص الجودة والحزم. الويب سحابي فقط، والمرفقات خاصة، والنسخ التلقائية مفعلة.",
      next_step:
