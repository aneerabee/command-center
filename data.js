...
const SVC = [
  ...
  {
    name: "BRIX Caddy Proxy",
    ar: "خادم بريكس العكسي",
    id: "brixtravel-caddy",
    st: 1,
    em: "🛡️",
    host: "Contabo VPS",
    ...
    owner: "BRIX Travel Website",
    owner_type: "project",
    path: "server:/opt/brixtravel",
    port: "80/443",
    schedule: "دائم",
    dt: "brixtravel-caddy · Docker container",
    info: "reverse-proxy حي لموقع BRIX (Caddy + Let's Encrypt TLS) على Contabo",
  },
  {
    name: "Wapy Cron",
    ar: "المهام المجدولة",
...
const TL = [
  {
    ...
    structure: [
      ...
      "logs_2.sqlite + state_5.sqlite — سجلات الحالة والجلسات",
    ],
...
const CLD = [
  ...
  },
  {
    ...
    used_in: ["Wapy.dev", "ADREEM Bot", "BRIX Travel Website", "LIBYA", "Dr. Muhsen Ledger"],
  },
  {
    nm: "Cloudflare",
    name: "Cloudflare",
