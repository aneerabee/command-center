...
const PRJ = [
  ...
  },
  {
    ...
    ops: [
      "stack معزول في /opt/brixtravel، لا يلمس Wapy ولا ADREEM",
  ...
  },
  {
    ...
    users_count: 1,
    priority: "med",
    next_milestone: "اختبار قبول عملي بدخول الإيميل/كلمة المرور لكل مستخدم ثم مراقبة أول 24 ساعة",
    summary:
      "ADREEM — دفتر مالي تشغيلي مستقل للويب وTelegram Bot. يعتمد على React 19 + Supabase + API معزول cloud-only + دخول مستخدمين بالإيميل وكلمة المرور.",
    local_path:
    ...
    related_services: ["ADREEM Bot Service", "ADREEM API Service"],
    related_tools: ["Claude Code"],
    ...
    ops: [
      ...
      "هوية ADREEM مطبقة في الكود والواجهة والبوت، وGitHub Pages والريبو الرسمي يعملان من aneerabee/adreem",
      ...
      "مصدر البيانات السحابي: صفوف ADREEM معزولة داخل Supabase ml_state عبر row id مثل adreem:adreem:main",
      ...
      "المستخدم يدخل من الرابط العام https://aneerabee.github.io/adreem/، والجلسة المؤقتة تحفظ في sessionStorage فقط وتوجهه إلى ledgerId الخاص به",
      "أمر /adduser في البوت معطل عمدًا ويرشد إلى صفحة الإدارة حتى لا تتكرر مسارات الصلاحيات",
      ...
      "بوت الإدخال يدعم اختيار حركة شهرية، ويحفظ قاعدة recurringRules فقط للحركة المعتمدة ويمنع التكرار عند ضغط التأكيد مرتين",
      "بوت ADREEM يدعم مطابقة رصيد فلوسي من Telegram: اختيار حساب كاش/شيك، عملة، رصيد فعلي، ملاحظة إلزامية، ثم حفظ reconciliation وتصحيح correction عند وجود فرق",
      "بوت ADREEM يعرض شاشة تنبيهات ذكية من نفس buildLedgerAlerts: مراجعة، فلوس ناقصة، أدفع، حركات متكررة، فروق مطابقة، حركات كبيرة، وتكرار محتمل",
    ...
    links_desc: {
      التطبيق: "الرابط الحي لاستخدام ADREEM من الهاتف والكمبيوتر",
      API: "فحص صحة ADREEM API العام خلف Caddy على Contabo",
      "إدارة المستخدمين": "صفحة إدارة مستخدمي ADREEM؛ تحتاج توكن الإدارة، ولا تحفظ التوكن الخام في Command Center",
    ...
    current_status: {
      ...
      blockers: [],
      use_guide:
        "للاستخدام اليومي: افتح https://aneerabee.github.io/adreem/ وسجّل الدخول بالإيميل وكلمة المرور، أو استخدم https://t.me/SystemAzol_bot إذا كان Telegram ID مربوطًا من الإدارة. لإضافة مستخدم افتح https://aneerabee.github.io/adreem/?admin=users مع توكن الإدارة. للتطوير المحلي استخدم /Users/rabeeshaban/Developer/adreem فقط، ثم npm run lint وnpm test وnpm run build قبل الدفع.",
    },
    claude_session: {
  ...
  },
{
    ...
    id: "dr-muhsen",
    kind: "financial-ledger",
    ar: "حساب الدكتور محسن",
    st: "a",
    em: "🩺",
    cl: "#0f2342",
    cl_brand: "#b08d57",
    brand_note: "Navy & Gold — هوية رسمية تعبّر عن الثقة والثبات",
    pct: 90,
    parent: "infra",
    parent_role: "personal-finance",
    revenue_model: "internal",
    ...
    repo_url: null,
    deploy_url: "http://100.116.69.101:3500",
    stack: [
      "React 18",
      "Vite 5",
      "TypeScript 5.9",
    ...
    subsystems: [
      "balance-engine-pure-tested",
      "sqlite-single-file",
      "three-movement-types",
      "computed-balances-per-currency",
      "statement-pdf-A4",
      "motion-ui-navy-gold",
      "auto-seed-on-first-run",
      "docker-isolated-deploy",
    ...
    ops: [
      ...
      "Express يقدّم الواجهة المبنية (dist) + /api على منفذ واحد (3001 داخل الحاوية)",
      "node:sqlite يتطلب Node 22 — لذا حاوية node:22-slim بدل Node 20 على الخادم",
      "داخل الحاوية يُستخدم npm (لا pnpm) لتفادي بوّابة سكربتات البناء",
      "بيانات أولية تُزرع تلقائياً من scripts/seed.json عند أول تشغيل إذا كان الجدول فارغاً (43 حركة)",
      "التحديث: ./deploy.sh (rsync + docker compose up -d --build + فحص صحة)",
      "⚠️ قاعدتا المحلي والسحابة منفصلتان — التعديلات الرسمية على السحابة",
    ],
    desc: "حساب الدكتور محسن — دفتر حساب رقمي مستقل\n\n🎯 الهدف:\nاستبدال ملف Apple Numbers القديم بمنظومة واضحة تعرض الرصيد المستحق للدكتور لحظياً (بالدولار والدينار) وتوثّق كل حركة، مع إصدار كشف حساب احترافي يُرسل للدكتور.\n\n💰 المنطق:\nثلاثة أنواع حركات: وارد من الدكتور (يزيد) + مكسب (يزيد) + صادر للدكتور (يُنقص).\nالرصيد = (الوارد + المكاسب) − الصادر لكل عملة. محرك الحساب دالة نقية مُختبَرة (6 اختبارات) تطابق ملف Numbers الأصلي تماماً: 665,000 دولار + 2,012 دينار.\n\n🏗️ البنية:\nReact + Vite (واجهة) + Express (خادم) + SQLite مدمج في Node (ملف واحد). قطع مستقلة: shared/balance.ts (المحرك)، server/ (API + قاعدة)، src/ (واجهة)، scripts/seed.json (الاستيراد).\n\n🎨 الهوية:\nNavy & Gold رسمية — بطاقات كحلية بلمسة ذهبية (دولار) وفولاذية (دينار)، حركات framer-motion (عدّاد تصاعدي، ظهور متدرّج، لمعان)، عربي RTL بأرقام إنجليزية.\n\n🧾 كشف الحساب:\nمستند A4 احترافي (الرصيد + كل الحركات) يُحفظ PDF عبر الطباعة، بدون اسم شركة.\n\n☁️ النشر:\nحاوية Docker على Contabo، وصول Tailscale خاص فقط، بلا تسجيل دخول بعد (لذا تبقى خاصة). معزول تماماً عن مشروع التسعير وكل المشاريع.",
    tags: [
      "React",
      "Vite",
      "Express",
    ...
    path: "/Users/rabeeshaban/Developer/dr-muhsen",
    links: {
      "النظام الحي (Tailscale)": "http://100.116.69.101:3500",
    },
    links_desc: {
      "النظام الحي (Tailscale)":
        "الواجهة الحية على Contabo — تُفتح فقط من جهاز عليه Tailscale بحسابك (خاصة، ليست على الإنترنت العام)",
    },
    current_status: {
      updated: "2026-06-07",
      where:
        "حيّ على Contabo داخل حاوية Docker (dr-muhsen)، مربوط بعنوان Tailscale فقط عبر http://100.116.69.101:3500 (الوصول العام مرفوض — تأكّد). صورة node:22-slim تبني الواجهة وتشغّل Express على منفذ واحد، قرص dr-muhsen-data دائم، restart=unless-stopped. زُرعت 43 حركة تلقائياً عند أول تشغيل. الأرصدة المتحقّقة: 665,000 دولار + 2,012 دينار (مطابقة لملف Numbers الأصلي ولجدول الأرصدة فيه). فحص الأنواع نظيف و6 اختبارات تمرّ. الميزات: بطاقتا رصيد متحرّكتان، سجل الحركات بالبحث والتصفية، إضافة/تعديل/حذف، كشف حساب PDF احترافي. مجموع المكسب وشريط الوارد/الصادر مخفيان حالياً بطلب المستخدم (يُبنى تدريجياً).",
      next_step:
        "أولاً: إضافة تسجيل دخول (auth) قبل أي فتح عام لأن البيانات مالية حسّاسة. ثانياً: قرار حول توحيد قاعدتي المحلي والسحابة (الرسمية الآن هي السحابة). ثالثاً (لاحقاً): تقارير شهرية + رسم بياني للرصيد عبر الزمن + بحث ذكي.",
      blockers: [
        {
          text: "لا يوجد تسجيل دخول بعد — لذلك التطبيق مربوط بـTailscale فقط ولا يُعرض للإنترنت العام. أي فتح عام يتطلب auth أولاً.",
          priority: "medium",
        },
        {
          text: "قاعدتان منفصلتان: محلية على الماك وسحابية على الخادم — لا تتزامنان تلقائياً. التعديلات الرسمية على السحابة.",
          priority: "low",
        },
        {
          text: "غير مرفوع على GitHub بعد (يعيش محلياً + على الخادم فقط).",
          priority: "low",
        },
      ],
      use_guide:
        "للفتح: من جهاز عليه Tailscale بحسابك، افتح http://100.116.69.101:3500. للتطوير المحلي: cd ~/Developer/dr-muhsen && pnpm install && pnpm dev → http://localhost:5173. للنشر/التحديث: ./deploy.sh (يرفع التغييرات ويعيد بناء الحاوية ويتحقّق). لإصدار كشف: زر «إصدار كشف حساب» ثم «حفظ PDF / طباعة».",
    },
    claude_session: {
      session_name: "[dr-muhsen]",
      terminal: "Claude Code",
      cwd: "/Users/rabeeshaban/Developer/dr-muhsen",
      command: "cd ~/Developer/dr-muhsen && claude",
...
const SVC = [
  ...
  },
  {
    ...
    info: "ADREEM bot يعمل على Contabo من /home/argaz/apps/adreem. ملف adreem.env بصلاحية 600، والـ allowlist/registry مفعّلان. إنشاء المستخدمين لم يعد من البوت؛ /adduser يعرض رسالة توجيه إلى صفحة إدارة الويب لإنشاء إيميل وكلمة مرور. البوت يستهلك ledgerId والصلاحيات من registry ويدعم إدخال/مراجعة الحركات ومطابقة الرصيد.",
    last_check: "2026-06-08 Contabo runtime",
    config_paths: [
      ...
      "server:/home/argaz/logs/adreem-bot.log",
      "server:/home/argaz/logs/adreem-bot-error.log",
    ],
    why: "هذه الخدمة تجعل بوت ADREEM يعمل من السحابة 24/7 بدل الاعتماد على MacBook، وتمنع فقد الرسائل أو ازدواجية polling. لا علاقة لها بجلسة Claude telegram plugin التي تظهر داخل Terminal.",
  },
  {
    ...
    info: "خدمة API ل ADREEM تعمل من /home/argaz/apps/adreem عبر `npm run api:adreem` على المنفذ 8787. آخر تحقق 2026-06-08: /health و /api/ledger نجحا عبر verify:runtime، و/api/admin/users نجح بتوكن إدارة hashed، و/api/auth/login يدعم دخول الإيميل وكلمة المرور. التوكن الخام غير محفوظ في env.",
    last_check: "2026-06-08 Contabo runtime",
    config_paths: [
      "server:/home/argaz/apps/adreem",
      "server:/home/argaz/apps/adreem/adreem.env",
      "server:/home/argaz/.config/systemd/user/adreem-api.service",
      "server:/home/argaz/logs/adreem-api.log",
      "server:/home/argaz/logs/adreem-api-error.log",
    ],
    why: "خدمة REST API لمشروع ADREEM (المركزية للحسابات). تَعرض نقاط النهاية المالية على المنفذ 8787 من Contabo. مكمّلة لخدمة بوت ADREEM (التي تَستهلك الـAPI).",
  },
  {
...
{
    name: "Dr. Muhsen Ledger Service",
    ar: "خدمة حساب الدكتور محسن",
    id: "dr-muhsen-svc",
    st: 1,
    em: "🩺",
    host: "Contabo VPS",
    runtime: "Docker (node:22-slim) / Express + node:sqlite",
    service_type: "web-app",
    prj: "Dr. Muhsen Ledger",
    owner: "Dr. Muhsen Ledger",
    owner_type: "project",
    path: "server:/home/argaz/dr-muhsen",
    ...
    config_paths: [
      ...
      "server:/home/argaz/dr-muhsen/docker-compose.yml",
      "server:/home/argaz/dr-muhsen/Dockerfile",
      "docker volume: dr-muhsen-data (/app/data/ledger.db)",
    ],
...
const AUTO = [
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        on: true,
        what: "يشغّل ~/.local/bin/cc-health-monitor.sh كل 15 دقيقة لمراقبة صحة الخدمات (لوغات: ~/Library/Logs/cc-health-monitor.log). State حاليّاً: not running بين الدورات (طبيعي لمهمّة دوريّة قصيرة).",
        prj: ["Command Center"],
        path: "/Users/rabeeshaban/Library/LaunchAgents/com.rabeeshaban.cc-health-monitor.plist",
        kind: "automation",
      },
      {
...
const BOT = [
  ...
  },
  {
    ...
    started_at: null,
    pid: null,
    exec_start: "/usr/bin/npm run bot:adreem → node server/telegram/bot.js",
    channel: "Telegram",
...
const CLD = [
  ...
  },
  {
    ...
    dt: "PostgreSQL متعدد المشاريع — مصدر حقيقة لـ4 منظومات + مصادقة محلّية لـLIBYA",
    lk: "https://supabase.com/dashboard",
    prj: "BRIX Travel System",
    related_entities: ["BRIX Travel System", "Money Manager", "ADREEM", "LIBYA"],
    used_in: ["BRIX Travel System", "Money Manager", "ADREEM", "LIBYA"],
  },
  {
    nm: "Vercel",
    name: "Vercel",
  ...
  },
  {
    ...
    related_entities: ["Claude Code Bot", "Tron Address Bot", "ADREEM Bot"],
    used_in: ["Claude Code Bot", "Tron Address Bot", "ADREEM Bot"],
  },
  {
    nm: "Contabo VPS",
    name: "Contabo VPS",
    ...
    prj: "Wapy.dev + ADREEM + Brixtravel",
    related_entities: ["Wapy.dev", "ADREEM Bot", "BRIX Travel Website"],
    used_in: ["Wapy.dev", "ADREEM Bot", "BRIX Travel Website"],
  },
  {
    nm: "Cloudflare",
    name: "Cloudflare",
...
const IDEAS = [
  {
    ...
    blueprint: {
      ...
      kept_as_is: [
        ...
        "Contabo — Wapy + ADREEM Bot (شغّالين)",
      ...
      what_changes: [
        ...
        {
          problem: "ADREEM Bot يحتاج macbook مفتوح",
      ...
      subdomain_map: [
        ...
        { sub: "ledger.rabee.dev",     to: "ADREEM",      host: "Cloudflare Pages" },
        ...
        { sub: "ledger-bot.rabee.dev", to: "ADREEM Bot",  host: "Contabo + CF Tunnel" },
      ...
      phases: [
        ...
        },
        {
          ...
          steps: [
            ...
            "ADREEM Bot → ledger-bot.rabee.dev (Cloudflare Tunnel)",
          ],
        },
        {
          n: 5,
