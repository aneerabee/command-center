...
const PRJ = [
  ...
  },
  {
    ...
    related_services: ["ADREEM API Service"],
    related_tools: ["Claude Code"],
    ...
    ops: [
      ...
      "2026-09-24: أُلغي بوت ADREEM نهائيًا وأُزيل من لوحة التحكم؛ الخدمة الوحيدة الباقية adreem-api.service، مع نسخ يومي 03:45 وجلسات دخول 90 يومًا",
...
const BOT = [
  ...
  },
  {
    ...
    summary: "قناة تحكم عن بُعد بـ Claude Code عبر Telegram؛ ليست بوت أي مشروع مالي.",
...
const IDEAS = [
  {
    ...
    blueprint: {
      ...
      kept_as_is: [
        ...
        "Contabo — Wapy + ADREEM API (شغّالين)",
