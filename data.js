...
const PRJ = [
  ...
  },
  {
    ...
    users_count: 3,
    priority: "med",
    next_milestone: "متابعة تشغيل بوت Contabo من repo محمد المستقل وإضافة checker آلي داخل runtime-sync",
    summary:
    ...
    current_status: {
      updated: "2026-05-23",
      where:
        "الواجهة الرسمية الحية منشورة على GitHub Pages عبر /mohammad-ledger/ وتعمل HTTP 200. المستودع الرسمي aneerabee/mohammad-ledger على commit 5da5a78. المسار المحلي المستقل هو /Users/rabeeshaban/Developer/mohammad-ledger. western-office تم تنظيفه من محمد على commit 42cdddd. بوت Contabo ما زال يعمل من /home/argaz/apps/mohammad-ledger-bot ويقرأ/يحفظ من نفس Supabase.",
      next_step:
        "متابعة تشغيل بوت Contabo من repo محمد المستقل وإضافة checker دوري داخل Command Center runtime-sync.",
      blockers: [
        {
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        freq: "يوميًا 06:00 UTC (~09:00 إسطنبول)",
        on: true,
        what: "أوّل من ٣ مراجعات يوميّة (الصباح): يستدعي /api/search بثلاث سيناريوهات حقيقيّة (Sueno، Rixos، Sueno+طفل)، يتأكّد Σ(period.subtotal) === offer.totalPrice في كلّ عرض، يرفض NaN/Infinity/قيم سالبة، يتأكّد offer.currency ليس فارغاً. صامت عند النجاح، يُرسل تلجرام + يفتح Issue عند الفشل. أُنشئ 2026-05-23.",
        prj: ["BRIX Travel System"],
      ...
      },
      {
        ...
        freq: "يوميًا 22:00 UTC (~01:00 إسطنبول)",
        on: true,
        what: "ثالث المراجعات الثلاث (المساء): يحمّل /results من الإنتاج، يستخرج رابط CSS bundle، يتأكّد أنّ الـbundle لا يزال يحوي طبقة BRIX CARD البصريّة (brix-card, brix-period, brix-total, brix-copy-btn, brixPriceLand keyframe). حارس ضدّ نشر يجرّد التصميم. يفحص أيضاً freshness على /api/version. صامت عند النجاح. أُنشئ 2026-05-23.",
        prj: ["BRIX Travel System"],
