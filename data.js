...
const PRJ = [
  ...
  },
  {
    ...
    ops: [
      ...
      "هوية ADREEM مطبقة في الكود والواجهة والبوت، وGitHub Pages أعيد بناؤه بنجاح من commit 7fe7ae6",
      ...
      "آخر تحقق قوي 2026-06-01: npm test نجح بـ105 اختبارات، npm run lint نجح، npm run build نجح، وفحص Chrome/CDP للهاتف والكمبيوتر بدون horizontal overflow",
      "اختبار سيناريوهات منطقي بعد آخر تعديل نجح: 29 تحقق لمسارات التحويل والمصروف والدخل وبيع/شراء الدولار وفلاتر عملة الحسابات",
      "GitHub Pages منشور من commit 7fe7ae6 عبر Workflow 26736568185، والرابط الحي رجع 200 بأصول جديدة index-vCPKq2uH.js و index-BcHir2BG.css",
      "تشغيل Contabo آخر تأكيد له كان على commit 758cfeb: adreem-api.service active و adreem-bot.service active، لكن تحديث السيرفر إلى 7fe7ae6 يحتاج دخول SSH صحيح وإعادة تشغيل الخدمات",
    ...
    current_status: {
      updated: "2026-06-01",
      where:
        "ADREEM منشور على GitHub Pages من commit 7fe7ae6. Workflow 26736568185 نجح: test + build + deploy. الرابط الحي يعمل ويخدم أصولًا جديدة للتصميم الجذري Receipt OS. API العام يعمل عبر https://www.brixtravel.com/adreem-api. محليًا نجحت 105 اختبارات، lint، build، وفحص الهاتف/الكمبيوتر بدون horizontal overflow. تم تحديث كود Telegram Bot في GitHub ليتناسق مع الويب في التقسيم والأزرار والنصوص. تنبيه: السيرفر/البوت على Contabo آخر نسخة مؤكدة لهما 758cfeb إلى أن يتم دخول SSH صحيح وتحديثهما.",
      next_step:
    ...
    claude_session: {
      ...
      note: "آخر نقطة 2026-06-01: ADREEM محدّث في GitHub إلى commit 7fe7ae6، وتم تطبيق اتجاه Receipt OS على الويب ومواءمة Telegram Bot معه، مع بقاء منطق البيانات كما هو. npm run lint وnpm test وnpm run build نجحت.",
    },
  },
  {
    name: "LIBYA",
...
const SVC = [
  ...
  },
  {
    ...
    dt: "adreem-api.service · active running · PID 228565",
    info: "مكتشَفة في تدقيق 2026-05-27: خدمة API ل ADREEM تَعمل من /home/argaz/apps/adreem عبر `npm run api:adreem` على المنفذ 8787. كانت غائبة عن لوحة التحكم رغم أنها فعّالة منذ مدّة.",
    last_check: "2026-05-27 Contabo runtime",
    config_paths: [
      "server:/home/argaz/apps/adreem",
      "server:/home/argaz/apps/adreem/adreem.env",
...
const BOT = [
  ...
  },
  {
    ...
    check_note: "adreem-bot.service active على Contabo من آخر نسخة مؤكدة commit 758cfeb. كود البوت المحلي/GitHub وصل إلى 7fe7ae6، لكن تحديث Contabo يحتاج دخول SSH صحيح وإعادة تشغيل الخدمة. Telegram getMe سبق ونجح للبوت SystemAzol_bot، وallowlist مفعّل لمستخدم Telegram المحدد. البوت القديم legacy mohammad-ledger-bot.service أصبح inactive لتجنب تضارب polling.",
    runtime: "Node.js 20.20.1 / systemd user",
    memory_mb: 48,
    started_at: null,
    pid: null,
    ...
    current_status: {
      updated: "2026-06-01",
      where:
        "يعمل على Contabo في /home/argaz/apps/adreem من آخر commit مؤكد 758cfeb. adreem-bot.service active وadreem-api.service active حسب آخر فحص سيرفر ناجح. الكود الأحدث في GitHub هو 7fe7ae6 ويحتوي إعادة تصميم Receipt OS للويب وتحسين Telegram UX ليتناسق معه، لكن تحديث السيرفر إليه يحتاج دخول SSH صحيح وإعادة تشغيل الخدمة.",
      next_step:
