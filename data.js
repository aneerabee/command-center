...
const PRJ = [
  ...
  },
  {
    ...
    ops: [
      ...
      "هوية ADREEM مطبقة في الكود والواجهة والبوت، وGitHub Pages أعيد بناؤه بنجاح من commit 62f3851",
      ...
      "GitHub Pages منشور من commit 62f3851 عبر Workflow 26717956257، والرابط الحي ورابط خيارات التصميم رجعا 200",
      "تشغيل Contabo آخر تأكيد له كان على commit 758cfeb: adreem-api.service active و adreem-bot.service active، لكن تحديث السيرفر إلى 62f3851 لم يتم من هذه الجلسة بسبب رفض SSH لكلمة المرور المتاحة",
    ...
    current_status: {
      updated: "2026-05-31",
      where:
        "ADREEM منشور على GitHub Pages من commit 62f3851. Workflow 26717956257 نجح: test + build + deploy. الرابط الحي يعمل، ورابط خيارات التصميم يعمل، وAPI العام يعمل عبر https://www.brixtravel.com/adreem-api. محليًا نجحت 104 اختبارات، lint، build، وفحص بصري للهاتف والكمبيوتر بدون overflow، مع تحسين أقسام ملف الحساب. تنبيه: السيرفر/البوت على Contabo آخر نسخة مؤكدة لهما 758cfeb إلى أن يتم دخول SSH صحيح وتحديثهما.",
      next_step:
    ...
    claude_session: {
      ...
      note: "آخر نقطة 2026-05-31: ADREEM محدّث في GitHub إلى commit 62f3851، رابط التصميم منشور، Pocket Ledger محسّن، وأقسام ملف الحساب صارت أوضح، والاختبارات المحلية والبناء والنشر نجحت.",
    },
  },
  {
    name: "LIBYA",
...
const BOT = [
  ...
  },
  {
    ...
    check_note: "adreem-bot.service active على Contabo من آخر نسخة مؤكدة commit 758cfeb. كود البوت المحلي/GitHub وصل إلى 62f3851، لكن تحديث Contabo لم يتم في فحص 2026-05-31 بسبب Permission denied عبر SSH. Telegram getMe سبق ونجح للبوت SystemAzol_bot، وallowlist مفعّل لمستخدم Telegram المحدد. البوت القديم legacy mohammad-ledger-bot.service أصبح inactive لتجنب تضارب polling.",
    runtime: "Node.js 20.20.1 / systemd user",
    memory_mb: 48,
    started_at: null,
    pid: null,
    ...
    current_status: {
      updated: "2026-05-31",
      where:
        "يعمل على Contabo في /home/argaz/apps/adreem من آخر commit مؤكد 758cfeb. adreem-bot.service active وadreem-api.service active حسب آخر فحص سيرفر ناجح. الكود الأحدث في GitHub هو 62f3851 ويحتوي تحسينات Pocket Ledger وتحسين ملف الحساب في الويب، لكن تحديث السيرفر إليها لم يكتمل من هذه الجلسة بسبب Permission denied في SSH.",
      next_step:
